...
export const getAlertsHistory = async (req: Request, res: Response) => {
    let alertData = Api.getAll(apiRegister.get_all_alerts_history_endpt(req.params.version), req, res);
    let result = await alertData;
    return result;
};

export const getAlertHistoryById = async (req: Request, res: Response) => {
    let alertData = Api.getAll(apiRegister.get_all_alerts_history_endpt(req.params.version) + "/" + req.params.alert_id, req, res);
    let result = await alertData;
    return result;
};
