...
export const getVersion = async (req: Request, res: Response) => {
    let versionData = Api.getAll(apiRegister.get_product_version_endpt(req.params.version), req, res);
...
export const getApplianceInfo = async (req: Request, res: Response) => {
    let applianceData = Api.getAll(apiRegister.get_appliance_info_endpt(req.params.version), req, res);
