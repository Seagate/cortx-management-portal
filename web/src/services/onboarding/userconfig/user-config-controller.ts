...
export const getUserConfig = async (req: Request, res: Response) => {
    let alertData = Api.getAll(apiRegister.user_config, req, res);
...
export const saveUserConfig = async (req: Request, res: Response) => {
    let alertData = Api.post(apiRegister.user_config, req, res);
    let result = await alertData;
    return result;
};
...
export const updateUserConfig= async (req: Request, res: Response) => {
    let alertData = Api.put(apiRegister.user_config, req, res, req.params.user_config_id);
    let result = await alertData;
    return result;
};