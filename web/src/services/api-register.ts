...
export default {
  ...
  udx_register_device: `/usl/${version}/registerDevice`,
  udx_registration_token: `/usl/${version}/registrationToken`,
  udx_saas: `/usl/${version}/saas`,
  udx_devices: `/usl/${version}/devices`,
