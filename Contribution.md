...
- [1.3 Submit your changes](#13-Submit-your-Changes)
   * [1.3.1 Clone the cortx-management-portal-repository](#131-Clone-the-cortx-management-portal-repository)
...
Contributing to the cortx-management-portal repository is a three-step process where you'll need to:

1. [Clone the cortx-management-portal repository](#131-Clone-the-cortx-management-portal-repository)
...
You'll need to **Fork** the cortx-management-portal repository to clone it into your private GitHub repository. Follow these steps to clone the repository to your gitHub account:
1. Navigate to the 'cortx-management-portal' repository homepage on GitHub.
2. Click **Fork**
3. Run the following commands in Shell:

   `$ git clone --recursive git@github.com:"your-github-id"/cortx-management-portal.git`
...
4. To Push your changes to GitHub, use: `$ git push origin 'your-local-branch-name'`
   ...
   remote: https://github.com/<your-GitHub-Id>/cortx-management-portal/pull/new/<your-local-branch-name>
   remote: To github.com:<your-GitHub-Id>/cortx-management-portal.git
...
Please contribute to the [CORTX Management Portal](https://github.com/Seagate/cortx/blob/main/doc/SuggestedContributions.md) initiative and join our movement to make data storage better, efficient, and more accessible. 
