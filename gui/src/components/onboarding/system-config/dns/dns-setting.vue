<template>
  <v-container class="mt-6 body-2">
    ...
    <div class="mt-5">
      <span class="font-weight-bold">FQDN Name :</span>
      <span class="font-weight-regular">vlan1.seagate.com</span>
    </div>
    <div class="mt-4">
      <span class="font-weight-medium black--text">Hostname</span>
      <div>
        <input class="input-text" type="text" name="hostname" v-model="hostname" />
      </div>
      <v-btn elevation="0" class="mt-5" color="green">
        <span class="white--text" @click="gotToNextPage()">Reset Hostname</span>
      </v-btn>
    </div>
    <v-divider class="mt-5 col-3" />
    <div>
      <div class="font-weight-medium black--text">DNS Server</div>
      <div class="pt-4 font-weight-regular black--text">DNS Server 1</div>
      <div>
        <input class="input-text" type="text" name="hostname" v-model="hostname" />
      </div>
      <div
    ...
    <v-divider class="mt-5 col-3" />
    <div>
      <div class="font-weight-medium black--text">Search Domains</div>
      <div class="pt-4 font-weight-regular black--text">Search Domains 1</div>
      <div>
        <input class="input-text" type="text" name="hostname" v-model="hostname" />
      </div>
      <div
      ...
      <v-btn elevation="0" color="green" class="mt-3">
        <span class="white--text" @click="gotToNextPage()">Clear DNS</span>
      </v-btn>
    </div>
