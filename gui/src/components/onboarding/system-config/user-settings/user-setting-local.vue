              ...
              <v-container>
                ...
                <v-row>
                  <v-col cols="12">
                    ...
                    <label class="cortx-rdb-container ml-4" id="localuser-adminlbl" v-if="isLoggedInUserAdmin()">
                      {{ $t("csmuser.admin") }}
                      <input
                        type="radio"
          ...
          <v-card>
            ...
            <v-card-text>
              <v-container>
                ...
                <v-row>
                  <v-col cols="12" v-if="!isLoggedInUserMonitor()">
                    <label class="mr-3">{{ $t("csmuser.roles") }}</label>

                    <label class="cortx-rdb-container ml-4" v-if="isLoggedInUserAdmin()">
                      {{ $t("csmuser.admin") }}
                      <input
                        type="radio"
