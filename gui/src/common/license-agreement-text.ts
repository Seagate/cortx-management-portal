  ...
  <tr>
    ...
    <td>
      ...
      <p>
        ...
        Product is subject to change at the sole discretion of
        Seagate.
      </p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <p>
        ...
        remote monitoring services of Your Seagate Storage Device
        and You give Seagate the right to collect the Collected
        Data in accordance with Seagate's privacy policy. Your
        right to use the Seagate Storage Device includes the
        performance of all of the various functions of the Support
        Tool and Your entitlement to receive related repair
        services from Seagate. You agree that the provision of the
        Support Tool may involve international transfers of data
        from You to Seagate and/or to Seagate's affiliates,
        sub-contractors or business partners. When making such
        transfers, Seagate shall endeavor to provide appropriate
        protection to safeguard the Collected Data being
        transferred in connection with the Support Tool.
        Additionally, Seagate shall endeavor to put in place
        appropriate technical and organizational measures to
        protect Collected Data against accidental or unlawful
        destruction or accidental loss, alteration, unauthorized
        disclosure or access. However, Seagate may need to
        reset/update the Product at any time in this Beta stage,
        which may cause data loss. Beta Product is not yet GDPR
        compliant and You expressly acknowledge that You
      ...
      <ul style="list-style-type: square;">
        <li>
          Return all Seagate Beta Products, including all hardware
          after Beta Cycle.
        </li>
        <li>
          Delete all data on Beta Products prior to returning
          them.
        </li>
      </ul>
    </td>
...
<p class="mt-5">
  In consideration of participation of this Beta Cycle Program, I,
  on behalf of myself and any entity I am authorized to represent,
  hereby WAIVE, FULLY RELEASE, AND DISCHARGE from any and all
  liability, claims, demands, damages, costs, expenses, actions,
  and causes of action as for any data loss, Seagate Technology
